...
if isempty(PP)
    ...
    PP.dir_temp='TEMP';                      % directory for storing temporary files
    PP.dir_data='';           % default directory to preappend to speech data file names
    PP.shorten='shorten.exe';            % location of shorten executable
    PP.flac='flac.exe';                  % location of flac executable
