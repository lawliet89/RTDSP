			       ...
			       DEPARTMENT OF ELECTRICAL AND ELECTRONIC ENGINEERING
 				      ...
 				      EE 3.19: Real Time Digital Signal Processing
					       Dr Paul Mitcheson and Daniel Harvey
				        		  ...
				        		  LAB 3: Interrupt I/O Exercise 2
 ************************************************************************************/
...
void ISR_AIC(void){	// code is generally similar to Lab 2
	float sample;	// the sample value
	Int16 output;	// output value
    ...
    output = (Int16) fabs(sample*gain);	// ouput saved to a variable for ease of debugging
